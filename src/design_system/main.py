...
def main(page: ft.Page):
    ...
    def build_inputs_view():
        ...
        def toggle_error(e):
            ...
            standard_input.error = state["input_error"]
    ...
    def make_nav_item(icon: ft.IconData, label: str, data_key: str):
        ...
        return ft.Container(
            ...
            animate=ft.Animation(150, ft.AnimationCurve.EASE_OUT_QUAD),
        )
    ...
    top_banner = ft.Container(
        ...
        border=ft.Border.only(bottom=ft.BorderSide(1, tokens.get_color("border", dark=False))),
    )
    ...
    sidebar_col = ft.Container(
        ...
        border=ft.Border.only(right=ft.BorderSide(1, tokens.get_color("border", dark=False))),
    )
